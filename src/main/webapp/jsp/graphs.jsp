    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-3">
            ...
            <select name="month" id="month" class="form-control"
                    onchange="onMonthChange(this.value,  document.getElementById('year').value)">
        ...
        <div class="form-group col-md-3">
            ...
            <select name="expense_type" id="expense_type" class="form-control"
                    onchange="onExpenseTypeChange(this.value, document.getElementById('month').value, document.getElementById('year').value)">
